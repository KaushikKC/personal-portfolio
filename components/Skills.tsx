                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mb-3'>
                    <div className='py-3'>
                        <Skill >
                            ...
                            <h1 className="text-white p-5  text-2xl font-bold hover:text-blue-700"   data-text="Communication">Communication</h1>
                        </Skill>
                    </div>
                    <div className='py-3'>
                        <Skill >
                            ...
                            <h1 className="text-white p-5  text-2xl font-bold hover:text-red-600" data-text="Problem Solving">Problem Solving</h1>
                        </Skill>
                    </div>
                    <div className='py-3'>
                        <Skill >
                            ...
                            <h1 className="text-white p-5  text-2xl font-bold hover:text-orange-600" data-text="Time Management">Time Management</h1>
                        </Skill>
                    </div>
                    <div className='py-3'>
                        <Skill >
                            ...
                            <h1 className="text-white p-5  text-2xl font-bold hover:text-green-600" data-text="Decision Making">Decision Making</h1>
                        </Skill>
                    </div>
                    <div className='py-3'>
                        <Skill >
                            ...
                            <h1 className="text-white p-5  text-2xl font-bold hover:text-sky-600"  data-text="Teamwork">Teamwork</h1>
                        </Skill>
                    </div>
                    <div className='py-3'>
                        <Skill >
                            ...
                            <h1 className="text-white p-4  text-2xl font-bold hover:text-purple-600" data-text="Money Management">Money Management</h1>
                        </Skill>
                    </div>
                </div>
...
const Skill = styled.div`
    ...
    & h1::before {
        ...
        /* -webkit-text-stroke: 1px var(hover-clr);
    }

    & h1:hover::before {
        width: 100%;
        filter: drop-shadow(0 0 1px #f0ee70);
    } */ */

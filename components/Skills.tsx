...
function Skills() {
  return (
    <div>
        ...
        <div>
        <Carousel responsive={responsive} className="relative w-[80%] mx-auto mb-10">
        ...
        <div>
            <div>
                ...
                <div className='flex flex-row flex-wrap'>
                    <div className=''>
                        <Skill >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-white mx-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    ...
                    <div className=''>
                        <Skill >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-white mx-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
